    ...
    <Card>
      <form className={classes.form} onSubmit={customerSubmitHandler}>
        <div className={classes.control}>
          ...
          <input type="text" placeholder="First Name" required id={firstNameRef} />
        </div>
        <div className={classes.control}>
          <label htmlFor="lastname">Last Name</label>
          <input type="text" placeholder="Last Name" required id={lastNameRef} />
        </div>
        <div className={classes.control}>
        ...
        <div className={classes.control}>
          ...
          <input type="text" placeholder="City Name" required id={cityRef} />
        </div>
        <div className={classes.control}>
          <label htmlFor="state">State</label>
          <input type="text" placeholder="State Name" required id={stateRef}  />
        </div>
        <div className={classes.control}>
